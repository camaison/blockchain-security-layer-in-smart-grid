...
/**
 * \brief Sets the timestamp used by the GoosePublisher instance
 *
 * \param self GoosePublisher instance
 * \param customTime the timestamp for when the message was generated
 */
LIB61850_API void
GoosePublisher_setTimestamp(GoosePublisher self, uint64_t customTime);
